...
public class UnitTests {
    ...
    public void testCalendarFormatIncorrectType() {
        new CalendarFormatter().format(new StringBuilder(), new String(),
                "yyyy.MM.dd HH:mm:ss");
    }

    @Test(expected = FormatterException.class)
    public void testCalendarFormatCalendarNullPointer() {
        new CalendarFormatter().format(new StringBuilder(), null,
                "yyyy.MM.dd HH:mm:ss");
    }

    @Test(expected = FormatterException.class)
    public void testCalendarFormatPatternNullPointer() {
        new CalendarFormatter().format(new StringBuilder(),
                Calendar.getInstance(), null);
    }

    @Test(expected = FormatterException.class)
    public void testCalendarFormatBufferNullPointer() {
        new CalendarFormatter().format(null, Calendar.getInstance(), "yyyy");
    }
    ...
    public void testLongFormatIncorrectFormatString() {
        new LongFormatter().format(new StringBuilder(), new Long(11), "i am d");
    }

    @Test(expected = FormatterException.class)
    public void testLongFormatNullPointerToBuffer() {
        new LongFormatter().format(null, new Long(11), "d");
    }

    @Test(expected = FormatterException.class)
    public void testLongFormatNullPointerToPattern() {
        new LongFormatter().format(new StringBuilder(), new Long(11), null);
    }

    @Test(expected = FormatterException.class)
    public void testLongFormatNullPointerToObject() {
        new LongFormatter().format(new StringBuilder(), null, "5d");
    }
