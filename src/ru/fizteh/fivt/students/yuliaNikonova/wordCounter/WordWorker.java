...
public class WordWorker {
    ...
    public WordWorker(boolean word, boolean lines, boolean uniqueCaseSensitive,
            boolean uniqueNotCaseSensitive, boolean aggregation,
        ...
        for (int i = 0; i < mFilenames.size(); i++) {
            ...
            try {
                ...
                while ((strLine = br.readLine()) != null) {
                    ...
                    if (mWords || mUniqueNotCaseSensitive
                            || mUniqueCaseSensitive) {
                        ...
                        for (int x = 0; x < result.length; x++) {
                            ...
                            if (mUniqueCaseSensitive) {
                                ...
                                if (mAggregation) {
                                    putValueInMap(allUniqueNotCaseSens,
                                            result[x].toLowerCase());
                                } else {
                                    putValueInMap(uniqueNotCaseSens,
                                            result[x].toLowerCase());
                                }
                            }
                        }
    ...
    private void printResults(int words, int lines,
            HashMap<String, Integer> myMap1, HashMap<String, Integer> myMap2) {
        if (mWords) {
